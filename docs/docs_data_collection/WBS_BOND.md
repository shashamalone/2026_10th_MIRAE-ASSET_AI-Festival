...
> **LEGACY 2026-07-11 분석:** 행 수·컬럼·기준일·PK가 현재 정본과 다릅니다. 현행 구조는 [RDB 정의서](../docs_data_layer/RDB_DEFINITION_V2_0.md)의 `raw.bond_kr_master`와 `enriched.bond_kr_*` 계약을 사용합니다.
