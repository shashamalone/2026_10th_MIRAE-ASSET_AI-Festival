...
RDB_SCHEMA["국내ETF"] = {
    ...
    "properties": {
        ...
        "cu_lev_fector": {"type": "text", "description": "레버리지 배수(1.0/1.5/2.0/-1.0/-2.0 등 7종). 음수가 인버스 상품이다. 10.2% 결측."},
        ...
        "pd_lste_dt": {"type": "text", "description": "상품거래종료일자(YYYYMMDD 숫자). 1,535건이 99991231(종료 예정 없음)이고 242건만 실제 종료일이 잡혀 있다."},
        "pd_lstg_dt": {"type": "text", "description": "상품거래가능일자(상장일, YYYYMMDD 숫자). 0.2% 결측."},
...
RDB_SCHEMA["해외ETF"] = {
    ...
    "properties": {
        ...
        "cu_lev_fector": {"type": "text", "description": "레버리지 배수(2.0/-2.0/3.0 등 11종). 85.1% 결측이라 결측이 곧 배수 1배를 뜻한다."},
