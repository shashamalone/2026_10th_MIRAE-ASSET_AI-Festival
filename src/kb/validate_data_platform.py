...
from kb.build_catalog import build_outputs, write_or_check  # noqa: E402
from kb.manifest import ROOT, validate_source_dir  # noqa: E402
...
def validate_stage(data_dir: str | Path | None = None) -> dict[str, object]:
    ...
    from kb.build_data_platform import dsn, validate_stage as validate_rdb_stage
    from kb.build_graph_instances import build as build_graph
    from kb.build_vectors import validate_vectors
